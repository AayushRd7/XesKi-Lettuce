 ...
 # Inspired & Modified from Varun Sir's Build Script
 # Custom build script
 #
...
export CROSS_COMPILE="/datadrive/aayush/aarch64-linux-android-4.9-kernel/bin/aarch64-linux-android-"
export ARCH=arm64
export SUBARCH=arm64
export KBUILD_BUILD_USER="AayushRd7"
export KBUILD_BUILD_HOST="XesKi-PoWeR"
MODULES_DIR=/datadrive/aayush/msm8916/common
OUT_DIR=/datadrive/aayush/msm8916/lettuce
...
cd $OUT_DIR
zip -r XeskiKernel_UBTC-v4.0.zip *
cd $KERNEL_DIR
BUILD_END=$(date +"%s")
